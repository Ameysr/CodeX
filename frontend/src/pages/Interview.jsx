            ...
            <div className="xl:col-span-2">
              ...
              >
                ...
                <button
                  ...
                  className={`w-full py-6 text-xl rounded-2xl transition-all duration-300 mb-8 flex items-center justify-center font-semibold shadow-lg transform hover:scale-105 active:scale-95 ${microphonePermission === 'denied'
                ...
                >
                  <div className="flex items-center justify-center space-x-3">
                    <div className={`w-3 h-3 rounded-full ${microphonePermission === 'denied'
                        ? 'bg-red-500'
                        : isRecording
                ...
                <div className="space-y-6 flex-grow overflow-y-auto max-h-[500px] pr-4 custom-scrollbar">
                  {conversation.map((entry, index) => (
                    <div
                      key={index}
                      className={`group transition-all duration-500 transform hover:scale-[1.02] ${entry.role === "user"
                          ? "ml-8 animate-slide-in-right"
                          : "mr-8 animate-slide-in-left"
                        }`}
                    >
                      <div
                        className={`p-6 rounded-2xl border backdrop-blur-sm ${entry.role === "user"
                      ...
                      >
                        <div className="flex items-center mb-3">
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center mr-3 ${entry.role === "user"
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-4">
                    {interviewOptions.map((option) => (
                      <div
                        key={option.id}
                        className={`p-4 rounded-xl border-2 cursor-pointer transition-all duration-300 transform hover:scale-105 ${interviewType === option.id
                      ...
                      >
                        <div className="flex items-center">
                          <div
                            className={`w-6 h-6 rounded-full border-2 mr-4 flex items-center justify-center transition-all duration-300 ${interviewType === option.id
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {difficultyLevels.map((level) => (
                      <div
                        key={level.id}
                        className={`p-4 rounded-xl border-2 cursor-pointer text-center transition-all duration-300 transform hover:scale-105 ${difficulty === level.id
                            ? level.id === "easy"
                ...
                >
                  ...
                  <div className="mt-8 flex justify-center">
                    <button
                      ...
                      className={`inline-flex items-center gap-3 px-8 py-4 rounded-xl font-semibold shadow-lg transition-all duration-300 transform hover:scale-105 active:scale-95 ${isGeneratingSummary
