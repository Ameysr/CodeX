            ...
            >
              ...
              {goalLoading ? (
                <div className="flex flex-col items-center">
                  <div className="w-32 h-32 rounded-full bg-gray-700 animate-pulse mb-6"></div>
                        ...
                        <tr key={i} className="border-b border-gray-800">
                          <td className="py-3 px-4">
                            <div className="flex items-center animate-pulse">
                              <div className="h-4 bg-gray-700 rounded w-1/4 mr-3"></div>
                              <div className="h-4 bg-gray-700 rounded w-3/4"></div>
                            </div>
                          </td>
                          <td className="py-3 px-4 text-center">
                            <div className="h-6 w-20 bg-gray-700 rounded-full mx-auto animate-pulse"></div>
                          </td>
                          <td className="py-3 px-4 text-center">
                            <div className="h-6 w-16 bg-gray-700 rounded-full mx-auto animate-pulse"></div>
                          </td>
                          <td className="py-3 px-4 text-center">
                            <div className="h-6 w-16 bg-gray-700 rounded-full mx-auto animate-pulse"></div>
                          </td>
